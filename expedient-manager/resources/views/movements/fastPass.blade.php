...
@section('title', 'Pase rápido de expedientes')
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-9 col-xs-12">
                    <div class="card">
                        <div class="card-header">Pase rápido de expedientes</div>
                        <div class="card-body">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select name="state" id="state" onchange="enableTextArea();"
                                                    ...
                                                    required>
                                                <option value="Pase ain despacho">Pase sin despacho</option>
                                                <option value="Pase con despacho">Pase con despacho</option>
                                            </select>
                                            <span role="alert" class="invalid-feedback">
                                            @if ($errors->has('state'))
